...
$.getJSON(url, function(data){
    ...
    for (var i = 0; i < data.chapter2.length; i++) {

       
        $("#app").append("<div class='aclass'><div>new class</div><img src='" + data.chapter2[i].image + "' ></div> ")
        $("#app").append("<h2>" + data.chapter2[i].title + "</h2>")
        $("#app").append("<h1>" + data.chapter2[i].description + "</h1>")
