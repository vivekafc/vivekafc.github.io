...
$.getJSON(url, function(data){
    ...
    for (var i = 0; i < data.chapter3.length; i++) {

       
        $("#app").append("<div class='aclass'><div>new class</div><img src='" + data.chapter3[i].image + "' ></div> ")
        $("#app").append("<h2>" + data.chapter3[i].title + "</h2>")
        $("#app").append("<h1>" + data.chapter3[i].description + "</h1>")
